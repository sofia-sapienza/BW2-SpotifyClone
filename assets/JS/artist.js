        ...
        .then(popolari =>{
            ...
            popolari.data.forEach((element,i) => {
                ...
                <div class="mb-5 me-2" style="background-image: url('${element.album.cover}'); width:50px; height: 40px; background-size: cover;" ></div>
                 <a href="#" style="text-decoration: none; color: white;" onclick="avviaBrano('${element.title}','${element.artist.name}','${element.album.cover}','${element.preview}')"><div class="w-100 ms-2 mb-5 mt-2" style="font-size:10px">${element.title_short}</div></a>
             </div>
